...
#include "cl.h" //maybe change back to CL/cl.h on rabbit
#include "cl_platform.h" //  maybe CL/cl_....
...
main( int argc, char *argv[ ] )
{
    ...
    //freopen("out.txt", "%8d\t%4d\t%10d\t%10.3lf GigaMultsPerSecond\n",
       // NMB, LOCAL_SIZE, NUM_WORK_GROUPS, (double)NUM_ELEMENTS/(time1-time0)/1000000000.,stdout);
