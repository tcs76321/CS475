...
void TimeOfDaySeed( )
{
    ...
    unsigned int seed = (unsigned int)(1000.0 * seconds);    // milliseconds
    srand(seed);
}
...
int main( int argc, char *argv[ ] ){
    ...
    printf("The probability of hitting the plate is: %8.8lf\n", currentProb);
    
    //(4) the MegaTrialsPerSecond
    printf("The maximum performance in megaTrialsPerSecond is: %8.8lf \n-----\n", maxPerformance);
